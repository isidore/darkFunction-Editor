...
import dfEditor.commands.AddDirNodeCommand;
import dfEditor.commands.AddGraphicListToSheetCommand;
import dfEditor.commands.GroupedUndoableCommand;
import dfEditor.commands.RemoveGraphicCommand;
import dfEditor.commands.RemoveGraphicListCommand;
import dfEditor.io.CustomFilter;
import dfEditor.io.ImageFilter;
import dfEditor.io.SpritesheetWriter;
...
public class SpriteImageController extends dfEditorPanel implements GraphicPanelChangeListener
{
  ...
  public SpriteImageController(CommandManager aCmdManager, JLabel aHelpLabel, TaskChangeListener aListener,
      JFileChooser aChooser)
  {
  ...
  public boolean save()
  {
    ...
    {
      int response = JOptionPane.showConfirmDialog(null, "Overwrite image \"" + savedImageFile.getName() + "\"?",
          "Image has been modified", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
  ...
  public boolean saveCoords(File aFile)
  {
    ...
    try
    {
      writer.createSpriteSheet(aFile, savedImageFile.getName(), nameTree, viewPanel.getImage().getWidth(),
          viewPanel.getImage().getHeight());
    }
    catch (IOException e)
    {
      JOptionPane.showMessageDialog(this, "Could not save the spritesheet!\n\n" + e.getMessage(),
          "Spritesheet not saved", JOptionPane.ERROR_MESSAGE);
      {
        return false;
      }
    }
  ...
  public boolean saveCoordsAs()
  {
    ...
    while (true)
    {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION)
      {
        ...
        {
          //Custom button text
          int response = JOptionPane.showConfirmDialog(null, "Overwrite existing coordinates?",
  ...
  private boolean saveImageAs()
  {
    ...
    while (true)
    {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION)
      {
        ...
        {
          //Custom button text
          int response = JOptionPane.showConfirmDialog(null, "Overwrite existing image?", "Confirm Overwrite",
        ...
        for (int i = 0; i < supportedFormats.length; ++i)
        {
          if (Utils.getExtension(f) != null && Utils.getExtension(f).equals(supportedFormats[i]))
          {
        ...
        else
        {
          ...
          JOptionPane.showMessageDialog(this, "Unsupported image format. The following formats are supported:\n\n"
              + formatsWithCommas, "Image save failed", JOptionPane.INFORMATION_MESSAGE);
        }
      }
      break;
    }
  ...
  private boolean saveImage(File aFile, String aFormat)
  {
    ...
    {
      JOptionPane.showMessageDialog(this, "Could not save the image!\n\n" + e.getMessage(), "Image not saved",
  ...
  public boolean load(String aFileName, DefaultTreeModel aModel)
  {
    if (aFileName == null)
    {
      JOptionPane.showMessageDialog(this, "Error loading sprites", "Corrupt sprites definition file",
          JOptionPane.ERROR_MESSAGE);
      return false;
    }
    ...
    if (!imgFile.exists())
    {
      JOptionPane.showMessageDialog(this, "Could not find image: \n\n" + aFileName, "Image not found",
          JOptionPane.ERROR_MESSAGE);
      return false;
    }
    ...
    {
      JOptionPane.showMessageDialog(this, "Couldn't load texture image.", "Error loading spritesheet!",
          JOptionPane.ERROR_MESSAGE);
    }
        ...
        if (!packer.packRects(viewPanel.getGraphicsBounds(), array, minSpacingField.getNum()))
        {
          JOptionPane
              .showMessageDialog(
                  ...
                  "Texture too small", JOptionPane.ERROR_MESSAGE);
        }
  ...
  private File[] showSetImageChooser()
  {
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) { return chooser.getSelectedFiles(); }
    return null;
  }
  ...
  private void initComponents()
  {
    ...
    viewPanelLayout.setHorizontalGroup(viewPanelLayout.createParallelGroup(
        javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 624, Short.MAX_VALUE));
    viewPanelLayout.setVerticalGroup(viewPanelLayout
            ...
            jPanel1Layout
                ...
                .addGroup(
                    jPanel1Layout
                        ...
                        .addComponent(untrimButton, javax.swing.GroupLayout.Alignment.TRAILING,
                            javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                            Short.MAX_VALUE)
                        .addComponent(trimButton, javax.swing.GroupLayout.Alignment.TRAILING,
                            javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                            Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(
                ...
                .addGroup(
                    jPanel1Layout
                        ...
                        .addGroup(
                            jPanel1Layout
                                .createSequentialGroup()
                                .addComponent(textureWidthField, javax.swing.GroupLayout.PREFERRED_SIZE, 44,
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(6, 6, 6)
                                .addComponent(jLabel2)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(textureHeightField, javax.swing.GroupLayout.PREFERRED_SIZE, 44,
                                    javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(minSpacingField, javax.swing.GroupLayout.PREFERRED_SIZE, 44,
                            javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(18, 18, 18).addComponent(packButton)
                                ...
                                .addGroup(
                                    jPanel1Layout
                                        ...
                                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 17,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(textureWidthField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel2)
                                        .addComponent(textureHeightField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(
                                    jPanel1Layout
                                        ...
                                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 13,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(minSpacingField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addComponent(packButton, javax.swing.GroupLayout.PREFERRED_SIZE, 52,
                            javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    spriteImageControllerLayout.setHorizontalGroup(spriteImageControllerLayout.createParallelGroup(
        javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        spriteImageControllerLayout
            .createSequentialGroup()
            .addContainerGap()
            .addGroup(
                spriteImageControllerLayout
                    .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(
                        spriteImageControllerLayout.createSequentialGroup()
                            .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 755, Short.MAX_VALUE)
                            .addContainerGap())
                    .addGroup(
                        spriteImageControllerLayout
                            .createSequentialGroup()
                            .addComponent(addSpriteButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(addFolderButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(removeSpriteButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 547,
                                Short.MAX_VALUE)
                            .addComponent(zoomInButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(zoomOutButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(10, 10, 10))
                    .addGroup(
                        spriteImageControllerLayout
    ...
    spriteImageControllerLayout.setVerticalGroup(spriteImageControllerLayout.createParallelGroup(
        javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        spriteImageControllerLayout
            .createSequentialGroup()
            .addContainerGap()
        ...
        .addGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout
                    .createSequentialGroup()
                    .addGap(0, 0, 0)
                    .addComponent(spriteImageController, javax.swing.GroupLayout.DEFAULT_SIZE,
  ...
  {//GEN-FIRST:event_addSpriteButtonActionPerformed
    ...
    if (selectedFiles != null)
    {
      ...
      for (int i = 0; i < selectedFiles.length; ++i)
      {
        ...
        {
          BufferedImage bufferedImage = ImageIO.read(selectedFiles[i]);
          SpriteGraphic graphic = new SpriteGraphic(bufferedImage, new java.awt.Point(0, 0), new Rectangle(0, 0,
              bufferedImage.getWidth(), bufferedImage.getHeight()));
          graphicList.add(graphic);
        }
        catch (IOException e)
        {
          JOptionPane.showMessageDialog(this, "Could not import " + selectedFiles[i].getName(), "Image not added",
              JOptionPane.ERROR_MESSAGE);
        }
      }
  ...
  private void addFolderButtonActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_addFolderButtonActionPerformed
    addDirToSelectedNode();
  }//GEN-LAST:event_addFolderButtonActionPerformed
  private void removeSpriteItemActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_removeSpriteItemActionPerformed
    removeSelectedSprites();
  ...
  private void removeDirItemActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_removeDirItemActionPerformed
    removeSelectedSprites();
  }//GEN-LAST:event_removeDirItemActionPerformed
  private void textureWidthFieldActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_textureWidthFieldActionPerformed
    viewPanel.setTextureArea(textureWidthField.getNum(), textureHeightField.getNum());
    viewPanel.repaint();
  }//GEN-LAST:event_textureWidthFieldActionPerformed
  private void textureHeightFieldActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_textureHeightFieldActionPerformed
    viewPanel.setTextureArea(textureWidthField.getNum(), textureHeightField.getNum());
    viewPanel.repaint();
  }//GEN-LAST:event_textureHeightFieldActionPerformed
  private void packButtonActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_packButtonActionPerformed
    pack();
  }//GEN-LAST:event_packButtonActionPerformed
  private void trimButtonActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_trimButtonActionPerformed
  ...
  private void untrimButtonActionPerformed(java.awt.event.ActionEvent evt)
  {//GEN-FIRST:event_untrimButtonActionPerformed
    ArrayList<GraphicObject> selectedGraphics = viewPanel.selectedGraphics();
    for (int i = 0; i < selectedGraphics.size(); ++i)
    {
      SpriteGraphic sprite = (SpriteGraphic) selectedGraphics.get(i);
